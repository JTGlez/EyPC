;Esto es un comentario texto random 
...
constanteSuma	=		constante + constanteHex ; 26d = 1Ah	;definicion de una constante asignada como la operacion de otras dos
;;;;;;;;;;; VARIABLES
variableMem		db 		constanteSuma ; 1Ah = 26d ;definicion de variable en memoria que contiene el valor de constanteSuma
;Caracteres (ASCII)
...
;Datos decimales codificados en binario 1d = 1h 
; 10d != 10h
; 0d = 0h
; 1d = 1h
;...
...
uninitArray		db 		100 dup(1)	;reserva 100 bytes no inicializados para la variable uninitArray
;____________________________________
...
;__________________________
	mov ax,[datoWord1]	;AX = datoWord1 = 09F0h
	mov bx,[datoWord2] 	;BX = datoWord2 = 87ACh

;	mov bx,[datoByte1]	;Error
